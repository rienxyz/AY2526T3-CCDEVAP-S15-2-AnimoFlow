/**
 * AnimoFlow - Find Your Room Page
 * 
 * Description: Search for classrooms and buildings across the DLSU campus.
 *              Users can search by room code (e.g., LS305) or building name.
 *              Returns building information, floor details, and directions.
 * 
 * Features:
 *   - Search by room code or building name
 *   - Current location selection (gates)
 *   - Direction images from selected gate to destination
 *   - Building database with room codes and floor information
 * 
 * Building Data: 10 buildings with codes, floor counts, and gate locations
 * API: GET /api/direction
