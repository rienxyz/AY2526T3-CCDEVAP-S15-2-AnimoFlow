/**
 * AnimoFlow - Buildings Directory Page
 * 
 * Description: Explore DLSU campus buildings and their information.
 *              Users can select a building from a dropdown to view
 *              its description, image, and key details.
 * 
 * Features:
 *   - Building selection dropdown
 *   - Building information display (description, image)
 *   - Clear button to reset view
 * 
 * Building Data: 10 campus buildings with descriptions and images
