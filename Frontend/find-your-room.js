...
function photoMarkup(image, buildingName) {
if (!image) {
  return "<div class='directions-photo-placeholder'>No photo saved for this route yet</div>";
}
return "<img class='directions-photo' src='" + image + "' alt='Directions to " + buildingName + "' loading='lazy' />";
}
...
return "<div class='result-card'>" +
  ...
  "<div class='directions-panel'>" +
    ...
    photoMarkup(image, buildingName) +
  "</div>" +
"</div>";
}
