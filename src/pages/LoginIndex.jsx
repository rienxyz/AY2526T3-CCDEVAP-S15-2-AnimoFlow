        ...
        <div className="col-lg-6 brand-panel">
          ...
          <ul className="feature-list">
            ...
            <li>
              ...
              <span>Classroom search by building, floor, or room#</span>
            </li>
        ...
        <div className="col-lg-6 form-panel">
          ...
          <form id="loginForm">
            <div className="input-group-custom">
              <label htmlFor="dlsuEmail">DLSU Email Address</label>
              ...
              <div id="emailError" className="invalid-feedback d-none">
                Email must be a valid DLSU address ending with @dlsu.edu.ph
              </div>
            ...
            <div className="input-group-custom">
              ...
              <div id="passwordError" className="invalid-feedback d-none">
                Password must be at least 8 characters long.
              </div>

              <small className="form-text">Min. 8 characters</small>
            </div>
