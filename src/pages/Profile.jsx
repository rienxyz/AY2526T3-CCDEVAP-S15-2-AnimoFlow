    ...
    <>
      <div className="main-container">
        ...
        <div className="page-header">
          ...
          <p>Manage your account details and view your contribution history.</p>
        </div>
          ...
          <div className="col-lg-8">
            ...
            <div className="card-custom">
              <div className="card-header-custom d-flex justify-content-between align-items-center">
                ...
                <button className="btn-refresh" id="refreshActivityBtn">
                  <i className="bi bi-arrow-repeat"></i> Refresh
                </button>
              </div>

              <div className="activity-list" id="activityList">
                <div className="text-center p-5 text-muted" id="emptyActivity">
                  <i
